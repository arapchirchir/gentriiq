                        ...
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title line-height-50 text-white">
                                    {{ config('app.name') }} is Your Trusted <br />
                                    Travel Companion.
                                </h2>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Founded in 2020, it is the Kenyan’s fastest growing safari company specializing in
                                creating the best spoken adventures in East Africa. We are well recognized as a leader
                                in our field and the company that is shaking up the safari industry.
                            </p>
                        </div>
                    </div>
                    <!-- end card-item -->
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                We offer a wide range of services including safaris, tours, travel, and
                                accommodation. We are committed to providing our clients with the best
                                possible service and ensuring that they have an unforgettable experience.
                            </p>
                        </div>
                    </div>
                    <!-- end card-item -->
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Our mission is to provide our clients with the best possible service and
                                ensure that they have an unforgettable experience. We are committed to
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading margin-bottom-40px">
                        <h2 class="sec__title">About {{ config('app.name') }}</h2>
                        <h4 class="title font-size-16 line-height-26 pt-4 pb-2">Founded in 2020, we are Kenya's
                            fastest-growing safari company, creating unparalleled spoken adventures in East Africa.
                            Recognized as leaders, we redefine the safari industry with innovative experiences.
                        </h4>
                        <p class="sec__desc font-size-16 pb-3">
                            Our exceptional team ensures unforgettable journeys, offering tailored safari adventures
                            that exceed expectations. We prioritize customer satisfaction, delivering unique, immersive
                            experiences that capture the essence of East African wildlife.
                        </p>
                        <p class="sec__desc font-size-16 pb-3">
                            As industry pioneers, we continuously innovate, setting new standards in safari tourism. Our
                            commitment to excellence and sustainability makes us the preferred choice for extraordinary
                            East African adventures. Join us for unmatched explorations.
                        </p>
                        <p class="sec__desc font-size-16 d-none">
                            We are dedicated to providing the best possible service to our clients, ensuring they have
                            an
                            unforgettable experience. Our team is committed to delivering exceptional service, ensuring
                            that our clients have the best possible experience.
                        </p>
                    </div>
                    <!-- end section-heading -->
                </div>
                ...
                <div class="col-lg-5 ms-auto">
                    <div class="image-box about-img-box">
                        <img src="{{ asset('assets/images/img24.jpg') }}" alt="about-img"
                            class="img__item img__item-1" />
                        <img src="{{ asset('assets/images/img25.jpg') }}" alt="about-img"
...
================================= -->
    ...
    STAR FUNFACT AREA
================================= -->
    <section class="funfact-area padding-bottom-70px d-none">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
...
================================= -->
    <section class="testimonial-area section-bg section-padding d-none">
        <div class="container">
